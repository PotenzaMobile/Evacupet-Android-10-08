...
abstract public class DashboardActivity extends AppCompatActivity {
    ...
    TextView titleName;
    TextView tvPrivacy;
    TextView tvEvacuation,tv_events;
    ...
    private void init() {
        ...
        tvReport.setText("Report Emergency");
        ...
        tvFindEvt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (PassData.status) {
                    ...
                    sentIntentRightSide(getString(R.string.events),FindEvacationActivity.class);
        ...
        tv_events.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (PassData.status) {
                    ...
                    sentIntentRightSide(getString(R.string.find_evacuation),EventActivity.class);
