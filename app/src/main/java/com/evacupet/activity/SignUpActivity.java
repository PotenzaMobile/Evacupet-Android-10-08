...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void attemptSignUp() {
        ...
        if (checkPasswordPattern(password)) {
            edPassword.setError(getString(R.string.password_validation));
            focusView = edPassword;
            cancel = true;
        }
        ...
        if (TextUtils.isEmpty(reptPassword)) {
            ...
            cancel = true;
        } else if (checkPasswordPattern(reptPassword)) {
            edReptPass.setError(getString(R.string.password_validation));
            focusView = edReptPass;
            cancel = true;
    ...
    private boolean checkPasswordPattern(String password) {
        Pattern passwordREGEX = Pattern.compile("(?=.*[0-9])" + "(?=.*[A-Z])" + ".{8,}" + "$");
